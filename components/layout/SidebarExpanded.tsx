...
const SidebarExpanded = ({ handleSidebar }: props) => {
    return (
        <motion.div
            className={cn(
                "flex flex-col items-center w-16 h-full overflow-hidden text-indigo-300 bg-indigo-900 rounded",
            )}
        ...
        >
            ...
            <a className="flex items-center justify-center w-16 h-16 mt-auto bg-indigo-800 hover:bg-indigo-700" onClick={handleSidebar}>
